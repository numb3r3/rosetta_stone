"""adapt from fairseq https://github.com/mit-han-lab/lite-
transformer/blob/master/fairseq/modules/adaptive_softmax.py."""
...
class AdaptiveSoftmax(nn.Module):
    ...
    def __init__(
        ...
        if adaptive_inputs is not None:
            self.head = TiedHeadModule(
                adaptive_inputs.weights_for_band(0), input_dim,
                len(cutoff) - 1)
        else:
    ...
    def adapt_target(self, target):
        ...
        scores for all the word of the vocabulary for all the examples.

        It is thus necessary to call the method adapt_target of the
        AdaptiveSoftMax layer inside each forward pass.
        """
