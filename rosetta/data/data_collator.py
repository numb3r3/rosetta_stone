...
class DataCollator(ABC):
    """A `DataCollator` is responsible for batching and pre-processing samples
    of data as requested by the training loop."""
...
class DefaultDataCollator(DataCollator):
    ...
    def collate_batch(
            self, features: List[InputDataClass]) -> Dict[str, torch.Tensor]:
