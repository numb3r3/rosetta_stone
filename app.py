...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='%s, a nlp toolkit based on pytorch. '
                    'Visit %s for tutorials and documents.' % (
                        ...
                        colored('https://git.huya.com/wangfeng2/rosetta_stone',
    ...
    parser.add_argument('-m', '--model', type=str, required=True,
                        help='the model name')
    parser.add_argument('-e', '--mode', type=str, default='train',
                        choices=['train', 'eval'], help='the running mode')
    parser.add_argument('-v', '--verbose', action='store_true',
                        default=False, help='turn on detailed logging for debug')
